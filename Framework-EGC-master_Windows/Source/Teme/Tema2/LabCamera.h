...
namespace Skyroad
{
	...
	public:
		...
		Camer(const glm::vec3& position, const glm::vec3& center, const glm::vec3& up)
		{
		...
		void MoveForward(float distance)
		{
			...
			// movement will keep the Camer at the same height always
			...
			// Translate the Camer using the DIR vector computed from forward
		}

		void TranslateForward(float distance)
		{
			// TODO : Translate the Camer using the "forward" vector
			position = position + glm::normalize(forward) * distance;
		}

		void TranslateUpword(float distance)
		{
			// TODO : Translate the Camer using the up vector
		...
		{
			// TODO
			// Translate the Camer using the "right" vector
			// Usually translation using Camer "right' is not very useful because if the Camer is rotated around the "forward" vector 
			// translation over the right direction will have an undesired effect; the Camer will get closer or farther from the ground
		...
		{
			// TODO
			// Rotate the Camer in Third Person mode - OX axis
		...
		{
			// TODO
			// Rotate the Camer in Third Person mode - OY axis
			TranslateForward(distanceToTarget);
		...
		{
			// TODO
			// Rotate the Camer in Third Person mode - OZ axis
			TranslateForward(distanceToTarget);
